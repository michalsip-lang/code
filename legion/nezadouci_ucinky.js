(function() {
  ...
  function createModal() {
    ...
    description.textContent =
      "Zvolte, jestli se jedná o formulář s hlášením autoritě, nebo bez hlášení autoritě.";
    ...
    withReportButton.textContent = "S hlášením autoritě";
    ...
    withoutReportButton.textContent = "Očekávaný nežádoucí účinek bez hlášení autoritě";
